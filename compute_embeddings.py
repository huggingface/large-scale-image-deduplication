...
def compute_embeddings(dataset_name, split='val', output_dir='embeddings', batch_size=512):
...
if __name__ == "__main__":
    ...
    compute_embeddings(args.dataset, args.split, args.output_dir, args.batch_size) 